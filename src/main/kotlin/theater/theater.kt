...
//    val spectacleController = SpectacleCommandLineController(SpectacleService(db.dataSource, spectacleDao),
...
//    val ticketController = TicketCommandLineController(TicketService(db.dataSource, TicketDao(db.dataSource)))
//    val showController = ShowCommandLineController(ShowService(db.dataSource, ShowDao(db.dataSource)))
...
//                            spectacleController.getSpectaclesOfGenre(it.substring("get spectacle of genre".length).trim())
//                        } else if (it.contains("of author life period")) {
//                            spectacleController.getSpectaclesOfCurAuthorLifePeriod(
//                                    it.substring("get spectacle of author life period".length).trim())
//                        } else if (it.contains("of author")) {
//                            spectacleController.getSpectaclesOfAuthor(it.substring("get spectacle of author".length).trim())
//                        } else if (it.contains("of country")) {
//                            spectacleController.getSpectaclesOfCountry(it.substring("get spectacle of country".length).trim())
//                        } else {
